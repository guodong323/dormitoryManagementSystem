      ...
      >
        ...
        <el-form-item label="学院" prop="stu_depart">
          <el-radio-group v-model="addstuForm.stu_depart">
            ...
            <el-radio-button label="国际学院"></el-radio-button>
            <el-radio-button label="软件学院"></el-radio-button>
            <el-radio-button label="通信学院"></el-radio-button>
            <el-radio-button label="自动化学院"></el-radio-button>
            <el-radio-button label="生物信息工程学院"></el-radio-button>
            <el-radio-button label="安法学院"></el-radio-button>
            <el-radio-button label="传媒艺术学院"></el-radio-button>
          </el-radio-group>
        </el-form-item>
